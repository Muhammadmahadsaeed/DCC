<?php
    ...
    $to_email = "mahadkhan809@gmail.com";
    ...
    $headers = "From:Fromname <$email_address>" . $eol;
    echo $headers;
     ...
     if(!$send_mail)
    {
        ...
        $output = json_encode(array('type'=>'message', 'text' => 'Hi there Thank you for applying for the job, will get back to you shortly'));
        die($output);
    }
?>